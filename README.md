About bioio-ome-zarr-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/bioio-ome-zarr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bioio-ome-zarr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add bioio-ome-zarr
# for installing globally
pixi global install bioio-ome-zarr
```
...
It is possible to list all of the versions of `bioio-ome-zarr` available on your platform:
...
```
pixi search bioio-ome-zarr --channel conda-forge
```
